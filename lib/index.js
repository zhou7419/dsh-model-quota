...
async function fetchQianwenPersonal(ctx, source, timeoutMs, signal) {
	...
	// The personal plan meters a rolling 7-day window; the usage API reports
	// when that window resets (`per1WeekResetTime`, epoch ms).
	const resetAt = typeof usage?.per1WeekResetTime === "number" && Number.isFinite(usage.per1WeekResetTime) ? usage.per1WeekResetTime : void 0;
	...
	return {
		...
		resetDate: resetAt !== void 0 ? new Date(resetAt).toISOString() : void 0,
